...
| `--model M` | per provider | override (default `gpt-4o` / `gemini-3.5-flash`) |
...
- OpenAI output is capped near 16K tokens/request; the ~6,000-char chunking stays well under it.
